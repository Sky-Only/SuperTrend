...
if __name__ == "__main__":
    # ==================== 在这里修改配置 ====================
    DATA_FILE = "沪金期货_10年日线.parquet"   # 数据文件路径
    DATA_NAME = "沪金期货"                    # 品种名称（用于图表标题）
    PERIOD = 11                              # SuperTrend ATR 周期
    MULTIPLIER = 4.4                          # SuperTrend 乘数 M
    CAPITAL = 1_000_000                      # 初始资金
    OUTPUT_DIR = f"沪金期货 {PERIOD},{MULTIPLIER}回测结果"           # 报告输出目录
    # ========================================================
